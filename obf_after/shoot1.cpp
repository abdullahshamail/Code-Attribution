...
#define ReplacementFor_sz(x) (int)(x).size()
 ...
 void ReplacementFor_forh(int ReplacementFor_ni, int ReplacementFor_nj, F f) {
 	...
 	for (;;) {
 		...
 		if (ReplacementFor_pa.second < 0 || ReplacementFor_board[ReplacementFor_pa.first][ReplacementFor_pa.second] == ((char)(0x1cc+534-0x3bf))) break;
 		f(ReplacementFor_pa);
 	}
 	...
 	for (;;) {
 		ReplacementFor_pa.second++;
 		if (ReplacementFor_pa.second >= C || ReplacementFor_board[ReplacementFor_pa.first][ReplacementFor_pa.second] == ((char)(0x39c+189-0x436))) break;
 		f(ReplacementFor_pa);
 	}
 }
 ...
 void ReplacementFor_forv(int ReplacementFor_ni, int ReplacementFor_nj, F f) {
 	...
 	for (;;) {
 		...
 		if (ReplacementFor_pa.first < 0 || ReplacementFor_board[ReplacementFor_pa.first][ReplacementFor_pa.second] == ((char)(0x113f+1042-0x152e))) break;
 		f(ReplacementFor_pa);
 	}
 	...
 	for (;;) {
 		ReplacementFor_pa.first++;
 		if (ReplacementFor_pa.first >= ReplacementFor_R || ReplacementFor_board[ReplacementFor_pa.first][ReplacementFor_pa.second] == ((char)(0x1e65+959-0x2201))) break;
 		f(ReplacementFor_pa);
 	}
 }
 ...
 void ReplacementFor_solve(int ReplacementFor_cs) {
 	...
 	ReplacementFor_rep(ReplacementFor_i,0,ReplacementFor_R) ReplacementFor_rep(ReplacementFor_j,0,C) {
 		...
 		if (c == ((char)(0x1c3f+2238-0x24aa))) ReplacementFor_sols[ReplacementFor_i][ReplacementFor_j] = ReplacementFor_solid++, ReplacementFor_solpa.emplace_back(ReplacementFor_i, ReplacementFor_j);
 		if (c == ((char)(0x1318+1496-0x189c))) ReplacementFor_turs[ReplacementFor_i][ReplacementFor_j] = ReplacementFor_turid++, ReplacementFor_turpa.emplace_back(ReplacementFor_i, ReplacementFor_j);
 	}
 	...
 	ReplacementFor_rep(ReplacementFor_i,0,ReplacementFor_R) ReplacementFor_rep(ReplacementFor_j,0,C) {
 		if (ReplacementFor_board[ReplacementFor_i][ReplacementFor_j] == ((char)(0xaad+3514-0x1814))) {
 			...
 			while (!ReplacementFor_q.empty()) {
 				...
 				ReplacementFor_rep(ReplacementFor_D,0,4) {
 					...
 					if (ReplacementFor_board[ReplacementFor_ni][ReplacementFor_nj] == ((char)(0xb98+613-0xdda))) continue;
 			...
 			ReplacementFor_rep(ReplacementFor_ni,0,ReplacementFor_R) ReplacementFor_rep(ReplacementFor_nj,0,C) if (ReplacementFor_board[ReplacementFor_ni][ReplacementFor_nj] == ((char)(0x176+127-0x1a1))) {
 	...
 	ReplacementFor_rep(ReplacementFor_i,0,ReplacementFor_R) ReplacementFor_rep(ReplacementFor_j,0,C) {
 		if (ReplacementFor_board[ReplacementFor_i][ReplacementFor_j] == ((char)(0x1655+2526-0x1fe0))) {
 			int ReplacementFor_sol = ReplacementFor_sols[ReplacementFor_i][ReplacementFor_j];
 			...
 			while (!ReplacementFor_q.empty()) {
 				...
 				ReplacementFor_rep(ReplacementFor_D,0,4) {
 					...
 					int ReplacementFor_nj = ReplacementFor_pa.second + ReplacementFor_DY[ReplacementFor_D];
 					if (ReplacementFor_ni < 0 || ReplacementFor_nj < 0 || ReplacementFor_ni >= ReplacementFor_R || ReplacementFor_nj >= C) continue;
 					if (ReplacementFor_board[ReplacementFor_ni][ReplacementFor_nj] == ((char)(0x1ad+5728-0x17ea))) continue;
 					if (ReplacementFor_dists[ReplacementFor_ni][ReplacementFor_nj] != INT_MAX) continue;
 					if (ReplacementFor_d + 1 > M) continue;
 					ReplacementFor_dists[ReplacementFor_ni][ReplacementFor_nj] = ReplacementFor_d + 1;
 	...
 	while (rem > 0) {
 		...
 		if (!ReplacementFor_hap) {
 			cerr << "WARNING!" << ((char)(0xed9+4328-0x1fa1)) << ReplacementFor_cs << endl;
 			ReplacementFor_rep(ReplacementFor_i,0,ReplacementFor_valid) {
 				if (!ReplacementFor_paths[ReplacementFor_i].empty()) ReplacementFor_done(ReplacementFor_i);
 			}
 			break;
 	...
 	ReplacementFor_trav(id, out) {
 		cout << id+1 << ((char)(0x1e22+732-0x20de)) << ReplacementFor_L[id]+1 << endl;
 	}
 }
